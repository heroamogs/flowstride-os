...
exports.DOMStripper = void 0;
class DOMStripper {
    static async getStrippedHTML(page) {
        try {
            const strippedHtml = await page.evaluate(() => {
                ...
                const hiddenElements = clone.querySelectorAll('[hidden], [aria-hidden="true"], [style*="display: none"], [style*="visibility: hidden"]');
...
exports.DOMStripper = DOMStripper;
